...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO predication (title, fb_link, description, image_url, author, publish_date) 
    VALUES (:title, :fb_link, :description, :image_url, :author, :publish_date)";
    ...
    echo "Preidcation/Priere published successfully!";
} else {
